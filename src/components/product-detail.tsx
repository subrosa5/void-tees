      ...
      <div>
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-3">
            <span className="font-mono text-xs tracking-[0.1em]">SIZE</span>
            <button type="button" className="font-mono text-[11px] tracking-[0.1em] text-muted hover:text-fg underline underline-offset-2 cursor-pointer">
              SIZE GUIDE
            </button>
          </div>
        ...
        <div className="mt-10 border-t-2 border-fg pt-6">
          <span className="font-mono text-xs tracking-[0.1em] block mb-3">DETAILS</span>
